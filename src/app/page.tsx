...
function Dashboard() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      {/* Sidebar */}
      <div className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-emerald-500 min-h-screen flex flex-col text-white p-5 transition-all duration-300`}>
        <div className='flex flex-col flex-grow'>
          ...
          {visibleMenuItems.map((item) => (
            <button
              ...
              className={`flex cursor-pointer hover:text-slate-300 hover:bg-emerald-400 hover:underline  items-center mb-2 p-2 rounded-md ${activeTab === item.name ? 'text-green-200 bg-emerald-400' : ''} ${sidebarOpen ? 'w-full mb-7' : 'w-10 mb-10'} overflow-hidden`}
            >
      ...
      <div className="flex flex-col w-full transition-width duration-300 ease-in-out"> 
        ...
        <div className="flex items-center justify-between m-2">
          ...
          <input
              ...
              className="text-slate-500 text-[20px] cursor-pointer border border-green-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 rounded-sm w-[600px] py-1 px-10 pr-12"
            />
            <svg
              className="absolute cursor-pointer right-3 top-1/2 transform -translate-y-1/2 h-6 w-6 text-emerald-500 hover:text-slate-800"
          ...
          <div className="flex space-x-8 mr-8">
            {/* <FaBell className="bg-white h-8 w-8 p-2 border border-black rounded-lg hover:bg-black hover:text-emerald-300 cursor-pointer" /> */}
            <div className="flex space-x-8 mr-8">
        <FaUser 
          className="bg-white h-8 w-8 p-2 border border-black rounded-lg hover:bg-black hover:text-emerald-300 cursor-pointer" 
